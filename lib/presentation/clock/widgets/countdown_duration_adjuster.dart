...
class CountdownDurationAdjuster extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final pageState = ref.watch(clockPageStateProvider);
    final pageNotifier = ref.read(clockPageStateProvider.notifier);
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      l10n.clockCountdownDuration(currentMinutes),
            ...
            if (pageState.isCountdownAdjusterExpanded) ...[
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    l10n.clockMinutes(currentMinutes),

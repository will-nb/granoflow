...
import '../utils/clock_timer_utils.dart';
...
class CountdownTimerDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 格式化倒计时时间
    final formattedTime = ClockTimerUtils.formatCountdown(countdownRemaining);
  ...
  double _calculateProgress() {
    ...
    if (isOvertime) {
      ...
      return ClockTimerUtils.calculateOvertimePercentage(

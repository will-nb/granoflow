  ...
  static final CompositeWaveGradient _lightWaveNormal = CompositeWaveGradient(
    ...
    layers: [
      ...
      WaveRadialGradientLayer(
        ...
        radius: 1.2,
        colors: [
          OceanBreezeColorSchemes.pomodoroTomatoRed.withValues(alpha: 0.3),
          OceanBreezeColorSchemes.pomodoroVibrantOrange.withValues(alpha: 0.2),
          Colors.transparent,
        ],
  ...
  static final CompositeWaveGradient _darkWaveNormal = CompositeWaveGradient(
    ...
    layers: [
      ...
      WaveRadialGradientLayer(
        ...
        radius: 1.0,
        colors: [
          OceanBreezeColorSchemes.pomodoroDeepTomatoRed.withValues(alpha: 0.3),
          OceanBreezeColorSchemes.pomodoroDeepOrange.withValues(alpha: 0.2),
          Colors.transparent,
        ],

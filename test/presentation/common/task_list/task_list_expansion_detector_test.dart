...
void main() {
  group('TaskListExpansionDetector', () {
    group('isMovedOutOfExpandedArea', () {
      ...
      test('should return false when dragged subtask is still within parent expanded area', () {
        ...
        final filteredTasks = [parentTask, draggedTask, siblingTask, _createTask(id: 4)];
      ...
      test('should return true when dragged subtask moves outside parent expanded area', () {
        final parentTask = _createTask(id: 1);
        final draggedTask = _createTask(id: 2, parentId: 1);
        final siblingTask = _createTask(id: 3, parentId: 1);
        ...
        final filteredTasks = [parentTask, draggedTask, siblingTask, otherRootTask];
      ...
      test('should return false when dragged subtask hovers over insertion index within parent area', () {
        final parentTask = _createTask(id: 1);
        final draggedTask = _createTask(id: 2, parentId: 1);
        final siblingTask = _createTask(id: 3, parentId: 1);
        final flattenedTasks = [
      ...
      test('should return true when dragged subtask hovers over insertion index outside parent area', () {
        final parentTask = _createTask(id: 1);
        final draggedTask = _createTask(id: 2, parentId: 1);
        final siblingTask = _createTask(id: 3, parentId: 1);
        final otherRootTask = _createTask(id: 4);
      ...
      test('should return true when dragged subtask hovers over its parent (parent is not in expanded area)', () {
        final parentTask = _createTask(id: 1);
        final draggedTask = _createTask(id: 2, parentId: 1);
        final flattenedTasks = [
          FlattenedTaskNode(parentTask, 0),
      ...
      test('should handle nested subtask (three levels)', () {
        ...
        final filteredTasks = [rootTask, parentTask, draggedTask, siblingTask, otherRootTask];
      ...
      test('should throw StateError when parent task not found in filteredTasks', () {
